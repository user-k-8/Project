        ...
        <div class="col-lg-4 col-md-6 col-sm-12 pb-1" id = product-id-${id}>
                <div class="card product-item border-0 mb-4">
                    ...
                    <div class="card-footer d-flex jjustify-content-center bg-light text-center">
                        <a href="" class="btn btn-sm text-dark p-0 justify-content-center" onclick = "addToCart(${id})" id = "${id}" ><i class="justify-content-center fas fa-shopping-cart text-primary mr-1 text-center"></i>Add To Cart</a>
                    </div>
                </div>
            </div>
